...
namespace OpenRA.Mods.RA2A.LoadScreens
{
	public sealed class RA2ALoadScreen : BlankLoadScreen
	{
		...
		public override void Init(ModData modData, Dictionary<string, string> info)
		{
			...
			if (info.ContainsKey("Image"))
			{
				...
				logo = new Sprite(sheet, new Rectangle(0, 0, 1024, 512), TextureChannel.Alpha);
				logoPos = new float2(r.Resolution.Width / 2 - 512, r.Resolution.Height / 2 - 256);
			}
		}
